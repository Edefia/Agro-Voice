...
const navItems = [
  ...
  { to: '/admin/ai-runs', label: 'AI Monitoring' },
    ...
    <div className="min-h-screen bg-surface-50 flex">
      ...
      >
        <div className="px-4 py-5 border-b border-surface-200">
          ...
          <p className="text-sm text-surface-500">Administration</p>
        </div>
      ...
      <div className="flex-1 flex flex-col min-w-0">
        <header className="sticky top-0 z-30 bg-white border-b border-surface-200 px-4 py-3 flex items-center gap-4">
          ...
          <div className="flex-1 min-w-0">
            ...
            <p className="font-medium text-surface-900 truncate">{user?.name ?? 'Admin'}</p>
          </div>
        </header>
